# declarejs
The best way to create JavaScript classes.  It brings structure and control to your client-side applications.  The syntax and features are similar to powerful languages like C#, C++, and Java.
