...
| ----- | ----- | ----- |
| template | **name**:string, **param1**:mixed | Generate datatypes and classes dynamically by passing parameters during runtime. |
| datatype | **name**:string, **parent**:string, **building**:function | Create a new datatype. |
