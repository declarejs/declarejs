...
declarejs = (function(){
	...
	declare("abs Base", function(keys, self, parent){return {
		...
		"thi set": function(name, value){
						...
						var t = typeof(this["set_" + name]);
			if(t !== "function") error("invalidSetter: " + this.__class + "::set_" + name + " is " + t);
			//else if(!this["set_" + name]) missingError(this.__class + "::set_" + name);
	...
	declare.version = function(){return version;}; // no direct access to this
		declare.inspect = inspect; // internal use only
		return declare;
